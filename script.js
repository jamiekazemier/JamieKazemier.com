...
const photoFeatureImage = document.getElementById('photo-feature-image');
...
const renderAlbumPreview = () => {
  ...
  if (photoFeatureImage) photoFeatureImage.src = activeAlbum.photos[0] || photoFeatureImage.src;
