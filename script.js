...
const projectData = {
  'erosion-sandbox': {
    ...
    description: 'Long-form terrain studies with erosion passes, shader tests, and cinematic framing iterations.',
    images: [
      'https://images.unsplash.com/photo-1477244075012-5cc28286e465?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1493244040629-496f6d136cc3?auto=format&fit=crop&w=1200&q=80'
    ]
  },
  'motion-rig-kit': {
    title: 'Motion Rig Kit',
    description: 'Mechanical prototypes and rig revisions focused on repeatable camera moves in dynamic conditions.',
    images: [
  ...
  'material-library': {
    ...
    description: 'Collected scans and reference captures converted into reusable surface assets for 3D environments.',
    images: [
...
const getPhotoMarkup = (url, albumTitle, index) =>
  `<figure class="photo-item" data-photo-wrap="${url}"><img src="${url}" alt="${albumTitle} photo ${index + 1}" /></figure>`;
